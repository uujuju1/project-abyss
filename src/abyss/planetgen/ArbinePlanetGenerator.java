...
public class ArbinePlanetGenerator extends SerpuloPlanetGenerator {
	...
	Block[][] arr =
	{
	{Blocks.water, Blocks.darksandWater, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.darksand, AbyssBlocks.granite, AbyssBlocks.granite, AbyssBlocks.granite, AbyssBlocks.granite, Blocks.darksandWater, Blocks.stone, Blocks.stone},
	{Blocks.water, Blocks.darksandWater, Blocks.darksand, Blocks.darksand, AbyssBlocks.granite, AbyssBlocks.granite, AbyssBlocks.granite, AbyssBlocks.granite, AbyssBlocks.granite, Blocks.darksandWater, Blocks.stone, Blocks.stone, Blocks.stone},
	{Blocks.water, Blocks.darksandWater, Blocks.darksand, AbyssBlocks.granite, Blocks.salt, AbyssBlocks.granite, AbyssBlocks.granite, AbyssBlocks.granite, AbyssBlocks.granite, Blocks.darksandWater, Blocks.stone, Blocks.stone, Blocks.stone},
	{Blocks.water, Blocks.sandWater, AbyssBlocks.granite, Blocks.salt, Blocks.salt, Blocks.salt, AbyssBlocks.granite, Blocks.stone, Blocks.stone, Blocks.stone, Blocks.snow, Blocks.iceSnow, Blocks.ice},
	{Blocks.deepwater, Blocks.water, Blocks.sandWater, AbyssBlocks.granite, Blocks.salt, AbyssBlocks.granite, AbyssBlocks.granite, Blocks.basalt, Blocks.snow, Blocks.snow, Blocks.snow, Blocks.snow, Blocks.ice},
	{Blocks.deepwater, Blocks.water, Blocks.sandWater, AbyssBlocks.granite, AbyssBlocks.granite, AbyssBlocks.granite, AbyssBlocks.calcarium, Blocks.iceSnow, Blocks.snow, Blocks.snow, Blocks.ice, Blocks.snow, Blocks.ice},
	{Blocks.deepwater, Blocks.sandWater, AbyssBlocks.granite, AbyssBlocks.granite, AbyssBlocks.calcarium, AbyssBlocks.calcarium, Blocks.snow, Blocks.basalt, Blocks.basalt, Blocks.basalt, Blocks.ice, Blocks.snow, Blocks.ice},
	{Blocks.deepwater, Blocks.darksandWater, Blocks.darksand, Blocks.darksand, Blocks.basalt, AbyssBlocks.calcarium, Blocks.basalt, Blocks.hotrock, Blocks.basalt, Blocks.ice, Blocks.snow, Blocks.ice, Blocks.ice},
	{Blocks.darksandWater, Blocks.darksand, Blocks.darksand, Blocks.darksand, AbyssBlocks.calcarium, AbyssBlocks.calcarium, Blocks.snow, Blocks.basalt, Blocks.basalt, Blocks.ice, Blocks.snow, Blocks.ice, Blocks.ice},
	{Blocks.darksandWater, Blocks.darksand, Blocks.darksand, AbyssBlocks.calcarium, Blocks.ice, Blocks.ice, Blocks.snow, Blocks.snow, Blocks.snow, Blocks.snow, Blocks.ice, Blocks.ice, Blocks.ice},
	{Blocks.deepwater, Blocks.darksandWater, Blocks.darksand, AbyssBlocks.calcarium, AbyssBlocks.calcarium, Blocks.ice, Blocks.ice, Blocks.snow, Blocks.snow, Blocks.ice, Blocks.ice, Blocks.ice, Blocks.ice},
	{Blocks.taintedWater, Blocks.darksandWater, Blocks.darksand, AbyssBlocks.calcarium, AbyssBlocks.calcarium, AbyssBlocks.calcarium, Blocks.iceSnow, Blocks.snow, Blocks.ice, Blocks.ice, Blocks.ice, Blocks.ice, Blocks.ice},
	...
	ObjectMap<Block, Block> dec = ObjectMap.of(
		AbyssBlocks.calcarium, Blocks.calcarium,
		AbyssBlocks.calcarium, Blocks.calcarium,
	...
	ObjectMap<Block, Block> tars = ObjectMap.of(
		AbyssBlocks.calcarium, Blocks.darksand,
		AbyssBlocks.calcarium, Blocks.darksand
	);
	...
	public Color getColor(Vec3 position){
		...
		if(block == AbyssBlocks.granite) return AbyssBlocks.granite.mapColor;
	...
	protected void generate(){
		...
		Seq<Block> ores = Seq.with(Blocks.oreCopper, Blocks.oreLead, Blocks.oreCoal, AbyssBlocks.oreSelemate);
		...
		pass((x, y) -> {
			//random moss
			if(floor == AbyssBlocks.calcarium){
				if(Math.abs(0.5f - noise(x - 90, y, 4, 0.8, 65)) > 0.02){
					floor = AbyssBlocks.calcarium;
				}
			}

			//tar
			if(floor == AbyssBlocks.granite){
			...
			}else if(floor != Blocks.basand && floor != Blocks.ice && floor.asFloor().hasSurface()){
				float noise = noise(x + 782, y, 5, 0.75f, 260f, 1f);
				if(noise > 0.67f && !roomseq.contains(e -> Mathf.within(x, y, e.x, e.y, 14))){
					if(noise > 0.72f){
						floor = noise > 0.78f ? Blocks.taintedWater : (floor == AbyssBlocks.granite ? Blocks.sandWater : Blocks.sandTaintedWater);
					}else{
						floor = (floor == AbyssBlocks.granite ? floor : AbyssBlocks.granite);
					}
					ore = Blocks.air;
				}
			}
